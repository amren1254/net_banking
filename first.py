...
def signup():
    ...
    password=raw_input('\n Enter your password')
    first=raw_input('How much do you want to credit as your initial balance(min. 3000)')
...
def transfer(crr):
    ...
    acc=raw_input('Enter the username of whom you want to transfer')
    data=[]
...
##            print 'Specified user not found'
    amt=int(raw_input('Enter amount to be transferred'))
